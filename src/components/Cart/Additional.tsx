...
export default function Offers() {
  ...
  return (
    <section className="bg-black relative flex flex-col items-center justify-center px-6 mx-auto w-full max-w-5xl gap-8 my-12">
      <div className="flex flex-wrap  border bg-black border-hack-green rounded-xl w-full z-10">
        <h2
            className={`${press_start.className} text-4xl md:text-4xl my-8 ml-8 text-hack-green  text-start z-10`}
        >
          Додаткові Опції
        </h2>
        {options.map((option) => {
