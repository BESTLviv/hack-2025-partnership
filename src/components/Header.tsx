  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`${press_start.className} bg-green-500 lg:py-[0.8vw] px-2 lg:px-[1.2vw] rounded-full h-fit leading-none lg:w-auto w-full text-black backdrop-blur-sm hover:scale-105 transition-all duration-500 relative z-30 hidden xl:flex items-center`}
      >
        Cтати партнером
      </button>
      <Dialog.Root>
